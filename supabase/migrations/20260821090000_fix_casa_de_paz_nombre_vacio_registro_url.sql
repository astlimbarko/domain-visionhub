-- VisionHub -- fix real encontrado al probar en vivo el registro publico por
-- URL: fn_registrar_persona_via_url devolvia casa_de_paz_nombre con un
-- SELECT directo a casa_de_paz.nombre, que casi siempre es NULL (desde
-- 23_etiqueta_cdp.sql el nombre de una CdP se calcula con fn_etiqueta_cdp --
-- nombre del lider + zona si hace falta desambiguar -- salvo que alguien le
-- haya puesto un nombre manual). El mensaje final de exito decia "quedo
-- registrado en ." vacio.
