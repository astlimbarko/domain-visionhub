-- VisionHub -- fix de la migracion anterior (20260907060000): la columna
-- real `tipo_evangelismo.color` es CHARACTER(7) (bpchar), no VARCHAR --
-- declarar la salida como VARCHAR sin castear el SELECT rompe la funcion
-- entera con "structure of query does not match function result type"
-- (42804), confirmado en vivo (la pantalla dejo de cargar). Se agrega el
-- cast explicito `::VARCHAR` en el SELECT.
