-- VisionHub -- KAN-230: agrega membresia_completada a fn_buscar_personas
-- para poder mostrar un indicador de membresia completa/incompleta en la
-- tabla de /afirmacion-personas. RETURNS TABLE cambia de forma -> DROP +
-- CREATE (mismo patron que 20260821020000).
