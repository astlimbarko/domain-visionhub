-- VisionHub -- KAN-350 (pedido explicito del owner, 2026-09-08): filtrar
-- "Personas evangelizadas" por quien evangelizo. A diferencia de Red/Casa de
-- Paz/Tipo (catalogos chicos y fijos), el evangelizador es cualquier persona
-- de la iglesia -- no tiene sentido un <select> con todos los miembros, asi
-- que el filtro llega como un persona_id ya elegido en el frontend con el
-- buscador existente (BuscadorPersona, mismo componente que ya se usa para
-- elegir este mismo campo al registrar un evangelizado nuevo).
