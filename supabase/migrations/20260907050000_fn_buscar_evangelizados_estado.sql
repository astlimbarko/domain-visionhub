-- VisionHub -- KAN-347 (pedido explicito del owner, 2026-09-07): en la
-- tarjeta mobile de "Personas evangelizadas" la burbuja de avatar mostraba
-- la inicial del nombre -- el owner pidio en su lugar el estado SSVA actual
-- de la persona (SIM/NC/CRE/RE, tabla `estado`/`persona_estado`), mismo
-- patron ya usado en otros listados (37_directorio_personas.sql,
-- 46_personas_de_red.sql). DROP primero porque se agrega una columna nueva
