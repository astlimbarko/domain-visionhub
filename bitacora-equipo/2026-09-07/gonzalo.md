...
- [x] Todo verificado en vivo con Playwright (viewport móvil real y desktop), 4 commits en la rama, `tsc -b` limpio en cada uno
- [x] Jira KAN-347 creado, cubre todo este bloque -- "En revisión" (falta merge a master + deploy, no "Finalizada" todavía)
