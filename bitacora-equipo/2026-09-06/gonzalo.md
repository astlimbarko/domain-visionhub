...
- [x] KAN-343 (nuevo, bug, sin arreglar): al abrir el menú de usuario (esquina superior derecha) toda la página se corre unos píxeles -- hipótesis sin confirmar: scroll-lock de Radix + padding-right compensando la scrollbar, podría afectar cualquier dropdown/dialog de la app. Pedido explícito del owner: queda en la cola, no se arregla ahora
