...
- [ ] Pendiente: terminar KAN-63, persistir cámara local (item 11), revisión visual autenticada (item 13), pruebas E2E de cierre (item 14), y arreglar la duplicación de `fn_puede_invitar_lider`/`fn_invitar_lider` antes del PR a master.
