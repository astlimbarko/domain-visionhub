...
- [x] Creado **KAN-251**: análisis detallado (problema + solución + plan de pruebas cuidando producción) de compartir roles entre iglesia madre y satélite (4 Anillo/Montero) — documentado para que quien lo tome lo entienda a fondo antes de implementar, assignee vacío a propósito (no es trabajo de esta sesión)
