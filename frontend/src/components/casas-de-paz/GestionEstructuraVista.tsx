...
export function GestionEstructuraVista() {
      ...
      <section className="overflow-hidden rounded-2xl border border-border/60 bg-card">
        ...
        <div className="flex flex-col gap-3 p-5">
          ...
          {redes.map((red) => (
            ...
            >
              <button type="button" className="flex items-center justify-between gap-2 text-left" onClick={() => setRedSeleccionadaId(red.id)}>
                <div className="min-w-0">
                  <p className="truncate font-medium">{red.nombre}</p>
      ...
      <section className="overflow-hidden rounded-2xl border border-border/60 bg-card lg:col-span-2">
        ...
        <div className="flex flex-col gap-4 p-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            {fusionesCdp.map((f) => (
              <div key={f.id} className="flex flex-col gap-2 rounded-lg border border-border px-3 py-2 text-sm sm:flex-row sm:items-center sm:justify-between">
                <div className="min-w-0">
                ...
                {f.puede_deshacer && (
                  <Button variant="ghost" size="sm" className="w-fit gap-1.5" onClick={() => setDeshacerCdpId(f.id)}>
          ...
          <div className="flex flex-col gap-2">
            ...
            {fusionesRed.map((f) => (
              <div key={f.id} className="flex flex-col gap-2 rounded-lg border border-border px-3 py-2 text-sm sm:flex-row sm:items-center sm:justify-between">
                ...
                {f.puede_deshacer && (
                  <Button variant="ghost" size="sm" className="w-fit gap-1.5" onClick={() => setDeshacerRedId(f.id)}>
                    <Undo2 className="h-4 w-4" />
                    Deshacer
                  </Button>
                )}
      ...
      <section className="overflow-hidden rounded-2xl border border-border/60 bg-card lg:col-span-2">
        ...
        <div className="flex flex-col gap-2 p-5">
          ...
          {invitacionesLider.map((inv) => (
            <div key={inv.id} className="flex flex-col gap-2 rounded-lg border border-border px-3 py-2 text-sm sm:flex-row sm:items-center sm:justify-between">
              <div className="min-w-0">
